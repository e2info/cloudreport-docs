...
- [帳票の登録・設定について](#setting)<br>
  ...
  - [マッピング情報をインポートされる際に指定しているエイリアスに不正があると表示されます](#setting6) 
- [出力について](#output)
...
<h3 id="setting6">Q.マッピング情報をインポートされる際に「」指定しているエイリアスに不正がある」と表示されます。</h3><br>

A.このエラーが出る場合、エイリアスが間違っている可能性があります。<br>
PORTERSにて追加したエイリアスがクラウドドキュメントに反映されていない可能性があります。<br>
そのため、まずはクラウドドキュメント上の左側のメニューから「フィールドが同期」を実行し、再度マッピングを試してみてください。
<br>
