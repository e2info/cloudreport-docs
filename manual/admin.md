...
- [5.HRBCからクラウドドキュメントをダウンロードする](#hrbc_dl)
  - [5-1.クラウドドキュメントを1件ダウンロードする](#hrbc_dl_1)
  - [5-2.クラウドドキュメントを一括ダウンロードする](#hrbc_dl_2)
...
初回はクラウドドキュメントの「HRBCフィールド取得」「HRBC選択肢の取得」画面にて、HRBCのデータと紐づける項目を同期します。
なお、HRBCで項目の追加・削除などの変更があった場合、クラウドドキュメント側も都度同期する必要があります。
...
ダウンロードは、「HRBCから出力したい成約IDの画面から出力する方法」と「クラウドドキュメントから成約IDを入力する方法」があります。<br>

詳細は[5.HRBCからクラウドドキュメントをダウンロードする](#hrbc_dl)　　[6.クラウドドキュメントから成約IDを入力してダウンロードする](#dl)をご確認ください。
<br><br>

<h3 id="login">クラウドドキュメントのログインについて</h3>
初回の設定を行う上で、クラウドドキュメントの画面は一度HRBCを経由してログインする必要があります。
...
その後遷移する画面にてPDFやExcelのダウンロードボタン、もしくは「HRBCに保存する」のPDFやExcelのダウンロードボタンを押しても課金されません。
...
#### HRBCのフィールドや選択肢の変更した場合、クラウドドキュメントを手動で同期する必要があります。
...
<h2 id="hrbc_dl">5.HRBCから帳票をダウンロードする</h2>

ここでは[3.帳票テンプレートの作成](#document_temp) で取り込んだ出力用の項目を、HRBCデータに紐づけを行います。

<h3 id="hrbc_dl_1">5-1.クラウドドキュメントを1件ダウンロードする</h3>
...
<h3 id="hrbc_dl_2">5-2.クラウドドキュメントを一括ダウンロードする</h3>
...
(2) 以降の操作は [5-1.クラウドドキュメントを1件ダウンロードする(4)](#hrbc_dl_1_4)をご参照ください。
...
(3) 以降の操作は [5-1.クラウドドキュメントを1件ダウンロードする(4)](#hrbc_dl_1_4)をご参照ください。
...
(4) 以降の操作は [5-1.クラウドドキュメントを1件ダウンロードする(4)](#hrbc_dl_1_4)をご参照ください。
<br><br>
...
<h3 id="dl_sp_1">7-1.HRBCの設定</h3>
※HRBCにシステム管理者権限でのログインが必要です。 <br>
(1)設定→カスタマイズの順に選択します <br>
(2)アクションメニュー編集を選択 <br>
(3)アクションメニューを設定するリソースを選択します <br>
(4)新規アクションメニューと追加します<br>
(5)URLを設定します<br>
![URL設定](images/dl_ledger/dl_sp_1.png)<br><br>
...
<h3 id="dl_sp_1">7-2.出力</h3>

### どのURLを入れるかによりアアクションボタン押下で帳票出力画面に遷移後の表示が異なります。<br>
