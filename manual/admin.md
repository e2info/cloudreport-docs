...
![すべての売上を選択](images/hrbc_dl/hrbc_dl_1.png)


(2) 「成約一覧」 または「売上一覧」右上の「一括アクション」のドロップダウンから「クラウド帳票(一括・本番)」を選択します。
![一括アクション](images/hrbc_dl/hrbc_dl_13.png)

※検証環境がある場合、検証環境でダウンロードしたい場合は「クラウド帳票(一括・検証)」を選択します。

※すべてのデータではなく、選択したデータのみのクラウド帳票を出したい場合は成約 IDの左横のチェックボックスに✓をつけます。）

(3) データの選択ウィンドウで「OK」を押下すると一括ダウンロード画面に切り替わります。
![一括ダウンロード画面](images/hrbc_dl/hrbc_dl_14.png)
...
![テンプレート名称を選択](images/hrbc_dl/hrbc_dl_15.png)

(5) 「ダウンロードする」ボタンを押下すると、一括ダウンロード出力画面に切り替わります。
![ダウンロード](images/hrbc_dl/hrbc_dl_16.png)

(6) 出力したいデータのファイル欄にある「ダウンロードする」を押下すると、「一括ダウンロード出力」画面に切り替わります。
![一括ダウンロード出力](images/hrbc_dl/hrbc_dl_17.png)

<br><br>

 ①アクション＝「ダウンロードする」の場合
(1)「ダウンロードする」の右側にあるEXCEL/PDFのボタンを押下します。
![EXCEL/PDFのボタン](images/hrbc_dl/hrbc_dl_18.png)

(2)画面左下に表示されるブラウザのダウンロードバーをクリックするとダウンロードしたEXCEL/PDFファイルが確認できます。
![ダウンロードしたファイル](images/hrbc_dl/hrbc_dl_7.png)

(3)PCのダウンロードフォルダにEXCEL/PDFファイルが保存されます。

![ファイルが保存されます](images/hrbc_dl/hrbc_dl_8.png)
...
![HRBCに保存する](images/hrbc_dl/hrbc_dl_21.png)

(2)上部に「HRBCにファイルを添付しました。」という緑色の帯が表示されたら「HRBCを開く」をクリックします。

![HRBCを開く](images/hrbc_dl/hrbc_dl_22.png)

(3)HRBC画面に切り替わり、「売上」ウィンドウが表示されます。「サブリスト｜ 添付ファイル」でダウンロードしたEXCEL/PDFファイルが確認できます。
